...
public class TelaBuscaReserva extends JDialog {
    ...
    public TelaBuscaReserva(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    private void initComponents() {
        setTitle("Busca de Reservas");
        setResizable(false);
        setAlwaysOnTop(true);
        ...
        JLabel labelTitulo = new JLabel("Reservas");
        ...
        jTableDados = new JTable(new DefaultTableModel(
                new Object[][]{},
                new String[]{"ID", "Data Reserva", "Prev. Entrada", "Prev. Saída", "Status", "Obs"}
        ));
        jTableDados.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

        int[] maxWidths = {40, 130, 130, 130, 60, 200};

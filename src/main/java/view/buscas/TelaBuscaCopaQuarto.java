...
public class TelaBuscaCopaQuarto extends JDialog {
    ...
    public TelaBuscaCopaQuarto(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    private void initComponents() {
        setTitle("Busca – Copa do Quarto");
        setResizable(false);
        setAlwaysOnTop(true);
        ...
        JLabel labelTitulo = new JLabel("Pedidos de Copa");
        ...
        jCBFiltro = new JComboBox<>(new String[]{"ID", "Quarto (ID)", "Produto (ID)", "Observação"});

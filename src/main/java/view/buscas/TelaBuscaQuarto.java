...
public class TelaBuscaQuarto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Descrição", "Capacidade", "Metragem", "Identificação", "Andar", "Animais?", "OBS", "Status"
            }
        ));
        ...
        if (jTableDados.getColumnModel().getColumnCount() > 0) {
            ...
            jTableDados.getColumnModel().getColumn(6).setMaxWidth(60);
            jTableDados.getColumnModel().getColumn(7).setMaxWidth(90);
            jTableDados.getColumnModel().getColumn(8).setMaxWidth(60);
        }
